...
const Ourplans= () => (
    ...
    <Row className="d-flex justify-content-center">
        ...
        <div className="ourplans2 d-flex justify-content-center mt-5">
        <Col md="9">
            <h2 className="d-flex justify-content-center mt-5"><bold> Our plans</bold> </h2>
            ...
            <span className="d-flex justify-content-center mt-3"> Already a member?  <button className="ml-2">Read more</button> </span>
            </Col>
         </div>
    </Row>
    </div>
